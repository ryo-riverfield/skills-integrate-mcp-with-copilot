...
Registration changes require an `Authorization: Bearer <token>` header from
`/auth/login`. Teacher credentials for this local exercise are stored in
`teachers.json`; replace them before deploying the application.
